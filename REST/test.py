...
if os.path.exists(args.in_txt):
    test_cases= read_data2(args.in_txt)
...
num_batches = (test_cases.shape[0] + args.batch_size - 1) // args.batch_size
...
if args.plot_first.lower() == 'true':
    ...
    print_rest(test_cases[0], all_outputs[0],f"rest_out_{test_cases.shape[0]}_{args.degree}-{args.degree}.txt")
    print()
